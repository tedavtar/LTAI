...
public class LoadBoard : MonoBehaviour {
	...
	void Awake () {
		...
		setUpBoard (3,11,4); //3,11,4 default board dimentions can change (ex. for blitz demos)

		BoardActions.addPieceToTile ("M");
	}
	

	void setUpBoard (int matrixSize, int membraneSize, int flagellaSize) {
